  ...
  resetPassword() async{
    try{
      ...
      if (e.code == "user-not-found"){
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("No user has registerd in this email.",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(child: Column(children: [
        ...
        Text("Enter your e-mail", style: TextStyle(color: Colors.white, fontSize: 20.0, fontWeight: FontWeight.bold,
        ),),
                    ...
                    children: [
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(hintText: "Email", hintStyle: TextStyle(fontSize: 18.0, color: Colors.white),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Text("Create", style: TextStyle( color: Color.fromARGB(225, 184, 166, 6),
